#!/usr/bin/env python3
"""
container_scanner.py -- Ver documentacion en el modulo correspondiente
"""
...
name = "container_scanner.py".replace(".py","")
print("\n  Modulo: 08-Container-Security/scripts/container_scanner.py")
